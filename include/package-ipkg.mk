...
)$$(call addfield,Replaces,$$(call mergelist,$(REPLACES))
...
$(_endef)
	...
	@rm -rf $$(IDIR_$(1)) $$(call opkg_package_files,$(1),$$(PDIR_$(1)))
	...
	(cd $$(IDIR_$(1))/CONTROL; \
		...
		( \
			...
			echo "[ -x "\$$$${IPKG_INSTROOT}/userdisk/miwifi/lib/functions.sh" ] || [ -x "\$$$${IPKG_INSTROOT}/lib/functions.sh" ] || exit 0"; \
			echo "[ -x "\$$$${IPKG_INSTROOT}/userdisk/miwifi/lib/functions.sh" ] && . \$$$${IPKG_INSTROOT}/userdisk/miwifi/lib/functions.sh"; \
			echo "[ -x "\$$$${IPKG_INSTROOT}/userdisk/miwifi/lib/functions.sh" ] || . \$$$${IPKG_INSTROOT}/lib/functions.sh"; \
    ...
    $(1)-clean:
	$$(if $$(call opkg_package_files,$(1),$$(PDIR_$(1))),rm -f $$(call opkg_package_files,$(1),$$(PDIR_$(1))))
